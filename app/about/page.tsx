      ...
      <div className="max-w-4xl w-full flex flex-col md:flex-row items-center md:items-start gap-12 text-center md:text-left">
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-gray-700 leading-relaxed font-light">
            Jag är bostadsfotograf i Stockholm med ett stort intresse för
            estetik och vackra hem. Mitt fokus är rena och naturliga bilder som
            lyfter fram rymd, ljus och känsla. Jag arbetar noggrant och stilrent
            för att få varje hem att se som bäst ut, både i foto och video.
          </p>
        </div>
      </div>
    </main>
